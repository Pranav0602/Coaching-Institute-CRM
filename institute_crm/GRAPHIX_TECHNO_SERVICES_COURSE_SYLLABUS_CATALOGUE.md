# Graphix Techno Services - Master Course Syllabus & Curriculum Catalogue

> **Authorized Central Government CAD/CAM/CAE Training Institute**
> Certified under ISO 9001:2015 & BECIL (Govt. of India Enterprise under Ministry of Information & Broadcasting)
> Website: [https://graphixtechnoservices.com/](https://graphixtechnoservices.com/)

## Executive Summary
This master catalog comprises the complete, industry-standardized course syllabuses offered by Graphix Techno Services. Every syllabus has been enriched with full module breakdowns, software versions, prerequisites, real-world capstone projects, and national/international engineering codes (ASME, ISO, ASHRAE, IS, IEEE, AWS).

---
## Table of Contents
1. [Mechanical AutoCAD (2D Drafting & 3D Modeling) (`MECH-AUTOCAD`)](#mech-autocad)
2. [Mechanical CATIA V5 (Part, Assembly, Surfacing & Drafting) (`MECH-CATIA-V5`)](#mech-catia-v5)
3. [Mechanical PTC Creo Parametric (3.0 / 7.0 / 9.0) (`MECH-CREO`)](#mech-creo)
4. [SolidWorks Mechanical Design & Simulation (`MECH-SOLIDWORKS`)](#mech-solidworks)
5. [Siemens NX CAD 10 / 12 (Advanced CAD Modeling & Synchronous Technology) (`MECH-NX-CAD`)](#mech-nx-cad)
6. [Autodesk Inventor Professional (3D Mechanical Design & Assemblies) (`MECH-INVENTOR`)](#mech-inventor)
7. [HVAC Design & Drafting Engineering Masterclass (`MECH-HVAC`)](#mech-hvac)
8. [Piping Design & Plant Engineering Masterclass (`MECH-PIPING`)](#mech-piping)
9. [Civil AutoCAD (Architectural & Structural 2D Drafting) (`CIVIL-AUTOCAD`)](#civil-autocad)
10. [Autodesk Revit Architecture (BIM Modeling Masterclass) (`CIVIL-REVIT-ARCH`)](#civil-revit-arch)
11. [Autodesk Revit Structure (Structural BIM & Rebar Detailing) (`CIVIL-REVIT-STRUCT`)](#civil-revit-struct)
12. [Autodesk 3ds Max Studio for Architectural Visualization (`CIVIL-3DSMAX`)](#civil-3dsmax)
13. [AutoCAD Advance Steel (Structural Steel Detailing & Fabrication) (`CIVIL-ADV-STEEL`)](#civil-adv-steel)
14. [AutoCAD Plant 3D (Process Piping & Plant Layout) (`CIVIL-PLANT-3D`)](#civil-plant-3d)
15. [Autodesk Navisworks Manage (BIM Coordination, Clash Detection & 4D/5D Simulation) (`CIVIL-NAVISWORKS`)](#civil-navisworks)
16. [Architectural Design & Visualization Master Track (`BIM-ARCH-DESIGN`)](#bim-arch-design)
17. [BIM (Building Information Modeling) Professional Track (`BIM-PROFESSIONAL`)](#bim-professional)
18. [Interior Design & Space Planning Masterclass (`BIM-INTERIOR-DESIGN`)](#bim-interior-design)
19. [Structural Design & Analysis Engineering Masterclass (`CIVIL-STRUCT-DESIGN`)](#civil-struct-design)
20. [Electrical AutoCAD (Schematics, Wiring & Control Panel Layouts) (`ELEC-AUTOCAD`)](#elec-autocad)
21. [Autodesk Revit MEP (Mechanical, Electrical, Plumbing BIM Modeling) (`MEP-REVIT-MEP`)](#mep-revit-mep)
22. [Electrical Design Engineering (Substations, Power Distribution & Lighting) (`ELEC-DESIGN`)](#elec-design)
23. [Core Java Programming (Java SE 17 / 21 LTS Masterclass) (`IT-CORE-JAVA`)](#it-core-java)
24. [J2EE & Advanced Java Frameworks (Spring Boot, Hibernate & REST) (`IT-ADV-JAVA`)](#it-adv-java)
25. [Java Full Stack Developer (React.js, Spring Boot, Microservices & Cloud) (`IT-JAVA-FULLSTACK`)](#it-java-fullstack)
26. [AWS Cloud Solutions Architect (Associate SAA-C03 Certified Track) (`CLOUD-AWS-ARCH`)](#cloud-aws-arch)
27. [Salesforce CRM Cloud (Administrator & Platform Developer Masterclass) (`CLOUD-SALESFORCE`)](#cloud-salesforce)
28. [Data Science, Machine Learning & Artificial Intelligence Masterclass (`IT-DATA-SCIENCE-AI`)](#it-data-science-ai)
29. [Corporate Communication & Personality Development Programme (`PRO-COMM-TRAINING`)](#pro-comm-training)

---

<a id='mech-autocad'></a>
# Mechanical AutoCAD (2D Drafting & 3D Modeling)
- **Course Code:** `MECH-AUTOCAD`
- **Engineering Discipline:** Mechanical CAD/CAM/CAE
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 15,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/autocad-classes-pune/](https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/autocad-classes-pune/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Course Completion Certification.

### Course Overview
Master mechanical computer-aided drafting and 3D modeling using Autodesk AutoCAD. This course is specially structured for mechanical, automobile, and production engineers to create manufacturing-ready drawings adhering to ISO/ASME standards with complete GD&T callouts.

### Target Audience & Prerequisites
Diploma / Degree in Mechanical, Automobile, Production Engineering or ITI Draughtsman Mechanical.

### Software Tools & Technologies Covered
- Autodesk AutoCAD 2024 / 2023
...
### Industrial Hands-on Capstone Projects
1. **Knuckle Joint & Cotter Joint 2D Assembly Drawing with Detailed Bill of Materials**
1. **Flange Coupling & Plummer Block 2D Fabrication Drawing with GD&T Callouts**
1. **Spur Gear & Shaft 3D Solid Model with Orthographic Multi-View Generation**

---

<a id='mech-catia-v5'></a>
# Mechanical CATIA V5 (Part, Assembly, Surfacing & Drafting)
- **Course Code:** `MECH-CATIA-V5`
- **Engineering Discipline:** Mechanical CAD/CAM/CAE
- **Duration:** 3 Months (Approx. 120 Hours)
- **Estimated Course Fee:** INR 22,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/catia-classes-pune/](https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/catia-classes-pune/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Training Certificate.

### Course Overview
Comprehensive mastery of Dassault Systèmes CATIA V5, the global benchmark for aerospace, automotive, and industrial equipment design. Covers parametric sketcher, solid part design, complex assembly design, generative surface modeling, and generative drafting.

### Target Audience & Prerequisites
BE/B.Tech/Diploma in Mechanical, Production, Automobile or Aerospace Engineering.

### Software Tools & Technologies Covered
- Dassault Systèmes CATIA V5 R20 / R21
...
### Industrial Hands-on Capstone Projects
1. **Automotive Engine Piston & Connecting Rod 3D Parametric Modeling**
1. **Automotive Sheet Metal Fender / Hood Complex Class-A Surface Modeling**
1. **Industrial Reduction Gearbox Complete Assembly with Clash Analysis & 2D Production Drawings**

---

<a id='mech-creo'></a>
# Mechanical PTC Creo Parametric (3.0 / 7.0 / 9.0)
- **Course Code:** `MECH-CREO`
- **Engineering Discipline:** Mechanical CAD/CAM/CAE
- **Duration:** 2.5 Months (Approx. 100.0 Hours)
- **Estimated Course Fee:** INR 18,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/mechanical-creo-3-0/](https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/mechanical-creo-3-0/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Course Certificate.

### Course Overview
Master PTC Creo Parametric (formerly Pro/ENGINEER), the industry leader in 3D feature-based parametric modeling. Learn robust solid modeling, assembly design, sheet metal design, advanced surfacing, and production detailing.

### Target Audience & Prerequisites
Diploma / Degree in Mechanical, Production, Automobile or Tool & Die Engineering.

### Software Tools & Technologies Covered
- PTC Creo Parametric 3.0 / 7.0 / 9.0
...
### Industrial Hands-on Capstone Projects
1. **Universal Joint Mechanism Assembly & Kinematic Motion Simulation**
1. **Sheet Metal Electrical Enclosure with Flat Pattern & CNC Bend Table**
1. **Centrifugal Pump Casing & Impeller 3D Modeling with Detailed Drawing Views**

---

<a id='mech-solidworks'></a>
# SolidWorks Mechanical Design & Simulation
- **Course Code:** `MECH-SOLIDWORKS`
- **Engineering Discipline:** Mechanical CAD/CAM/CAE
- **Duration:** 2.5 Months (Approx. 100.0 Hours)
- **Estimated Course Fee:** INR 18,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/solidworks-classes-pune/](https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/solidworks-classes-pune/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Course Certificate.

### Course Overview
Industry-focused training in Dassault Systèmes SolidWorks. Learn solid part modeling, complex assemblies, generative and interactive drafting, sheet metal fabrication design, weldments, and surface design with real-world mechanical projects.

### Target Audience & Prerequisites
Diploma / Degree in Mechanical, Automobile, Industrial, or Production Engineering.
...
### Industrial Hands-on Capstone Projects
1. **Industrial Machine Vise Assembly with Exploded View and Bill of Materials**
1. **Sheet Metal Computer CPU Enclosure with Forming Tools and Flat Pattern DXF**
1. **Welded Structural Pipe Rack & Industrial Staircase Frame with Cut List Table**

---

<a id='mech-nx-cad'></a>
# Siemens NX CAD 10 / 12 (Advanced CAD Modeling & Synchronous Technology)
- **Course Code:** `MECH-NX-CAD`
- **Engineering Discipline:** Mechanical CAD/CAM/CAE
- **Duration:** 3 Months (Approx. 120 Hours)
- **Estimated Course Fee:** INR 22,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/mechanical-uni-graphics-nx-cad-10/](https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/mechanical-uni-graphics-nx-cad-10/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Course Certificate.

### Course Overview
Master Siemens NX CAD (formerly Unigraphics NX), widely adopted by top-tier automotive and aerospace OEMs like GM, Nissan, Rolls-Royce, and Boeing. Covers advanced direct and parametric modeling, Synchronous Technology, Freeform Surfacing, and Assemblies.

### Target Audience & Prerequisites
Degree / Diploma in Mechanical, Production, Aerospace, or Automotive Engineering.

### Software Tools & Technologies Covered
- Siemens NX CAD 10 / 12 / 2000 Series
...
### Industrial Hands-on Capstone Projects
1. **Automotive Steering Knuckle CAD Modeling & Mass Optimization**
1. **Complex Aircraft Structural Bracket using Synchronous Technology & Direct Modeling**
1. **Industrial Valve Assembly with WAVE Inter-Part Associativity & 2D Production Detailing**

---

<a id='mech-inventor'></a>
# Autodesk Inventor Professional (3D Mechanical Design & Assemblies)
- **Course Code:** `MECH-INVENTOR`
- **Engineering Discipline:** Mechanical CAD/CAM/CAE
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 16,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/autodesk-inventor-classes-training-course-institute-in-pune/](https://graphixtechnoservices.com/courses/mechanical-cadcamcae-courses/autodesk-inventor-classes-training-course-institute-in-pune/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Course Certificate.

### Course Overview
Master Autodesk Inventor Professional for mechanical 3D CAD design, tooling, automated design accelerators, sheet metal fabrication, and weldments. Build digital prototypes and generate automated production drawings.

### Target Audience & Prerequisites
Diploma / Degree in Mechanical or Production Engineering.

### Software Tools & Technologies Covered
- Autodesk Inventor Professional 2023 / 2024
...
### Industrial Hands-on Capstone Projects
1. **Industrial Machine Vise Assembly with Design Accelerator Bolted Connections**
1. **Sheet Metal Electrical Cabinet with Flat Pattern DXF for CNC Laser Cutting**
1. **Structural Frame Conveyor Stand with Automated Cut List and Weldment Callouts**

---

<a id='mech-hvac'></a>
# HVAC Design & Drafting Engineering Masterclass
- **Course Code:** `MECH-HVAC`
- **Engineering Discipline:** Mechanical CAD/CAM/CAE
- **Duration:** 2.5 Months (Approx. 100.0 Hours)
- **Estimated Course Fee:** INR 20,000.00
- **Source Reference:** [https://graphixtechnoservices.com/hvac-desing-course/](https://graphixtechnoservices.com/hvac-desing-course/)
- **Certification:** Central Government ISO Certified & BECIL Authorized HVAC Design Engineer Certificate.

### Course Overview
Comprehensive training in Heating, Ventilation, and Air Conditioning (HVAC) design engineering for commercial, residential, and industrial infrastructure. Covers psychrometrics, heat load estimation (HAP), duct sizing (SMACNA), chilled water piping, and BIM modeling in Revit MEP.

### Target Audience & Prerequisites
BE/B.Tech/Diploma in Mechanical or Thermal Engineering.

### Software Tools & Technologies Covered
- AutoCAD HVAC
- Autodesk Revit MEP (HVAC)
...
### Industrial Hands-on Capstone Projects
1. **Complete Heat Load Calculation & Duct Design for a 4-Story Commercial Office Building using HAP**
1. **Hospital Clean Room Operation Theater (OT) Air Handling Unit & Duct Routing Project**
1. **Basement Jet Fan Ventilation & Staircase Pressurization System Design**

---

<a id='mech-piping'></a>
# Piping Design & Plant Engineering Masterclass
- **Course Code:** `MECH-PIPING`
- **Engineering Discipline:** Mechanical CAD/CAM/CAE
- **Duration:** 3 Months (Approx. 120 Hours)
- **Estimated Course Fee:** INR 22,000.00
- **Source Reference:** [https://graphixtechnoservices.com/piping-design-course/](https://graphixtechnoservices.com/piping-design-course/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Piping Design Engineer Certificate.

### Course Overview
Comprehensive professional piping engineering program for oil & gas, petrochemical, refinery, and power plants. Covers ASME B31.3 / B31.1 piping codes, P&ID development, equipment layout, 3D plant design in AutoCAD Plant 3D, and pipe stress analysis fundamentals.

### Target Audience & Prerequisites
Degree / Diploma in Mechanical, Chemical, Petroleum, or Production Engineering.
...
### Industrial Hands-on Capstone Projects
1. **Oil Refinery Crude Distillation Unit (CDU) Pump Station 3D Piping Layout**
1. **Chemical Storage Tank Farm Piping with Truck Loading Station**
1. **Automated Isometric Extraction & Material Take-Off (MTO) for Offshore Separator Module**

---

<a id='civil-autocad'></a>
# Civil AutoCAD (Architectural & Structural 2D Drafting)
- **Course Code:** `CIVIL-AUTOCAD`
- **Engineering Discipline:** Civil CAD
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 15,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/civil-cad-courses/95-2/](https://graphixtechnoservices.com/courses/civil-cad-courses/95-2/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Civil CAD Certificate.

### Course Overview
Professional drafting curriculum for civil engineers, architects, and site supervisors. Learn to prepare municipal sanction drawings, architectural layouts, structural reinforcement details, and building estimates following National Building Code (NBC) standards.

### Target Audience & Prerequisites
BE/B.Tech/Diploma in Civil Engineering, Architecture, or ITI Draughtsman Civil.
...
### Industrial Hands-on Capstone Projects
1. **G+2 Modern Residential Bungalow Complete Municipal Sanction Drawing Set**
1. **Multi-Family Apartment Typical Floor Plan with Structural Rebar Detailing**
1. **Commercial Retail Complex Site Plan with Parking, Landscaping, and Sectional Elevations**

---

<a id='civil-revit-arch'></a>
# Autodesk Revit Architecture (BIM Modeling Masterclass)
- **Course Code:** `CIVIL-REVIT-ARCH`
- **Engineering Discipline:** Civil CAD
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 18,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/civil-cad-courses/civil-revit-architecture/](https://graphixtechnoservices.com/courses/civil-cad-courses/civil-revit-architecture/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Revit Architecture Certificate.

### Course Overview
Full 30-day comprehensive building information modeling (BIM) program in Autodesk Revit Architecture. Learn parametric 3D building modeling, custom family creation, materials & photorealistic rendering, construction documentation, and multi-user worksharing.

### Target Audience & Prerequisites
Diploma / Degree in Civil Engineering, Architecture, Interior Design, or Construction Management.
...
### Industrial Hands-on Capstone Projects
1. **Luxury Residential Villa BIM Model with Custom Parametric Families, Walkthrough, and Schedule Sheets**
1. **Multi-Story Commercial Office Building with Curtain Wall Facade, Phasing, and Sun Studies**
1. **Complete Construction Working Drawing Sheet Package Exported to PDF and DWG**

---

<a id='civil-revit-struct'></a>
# Autodesk Revit Structure (Structural BIM & Rebar Detailing)
- **Course Code:** `CIVIL-REVIT-STRUCT`
- **Engineering Discipline:** Civil CAD
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 18,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/civil-cad-courses/civil-revit-structure/](https://graphixtechnoservices.com/courses/civil-cad-courses/civil-revit-structure/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Revit Structure Certificate.

### Course Overview
Specialized curriculum for structural engineers and detailers. Learn structural framing, foundation modeling, 3D reinforcement (rebar) modeling, structural steel joints, analytical model generation, and structural shop drawing creation.

### Target Audience & Prerequisites
Degree / Diploma in Civil or Structural Engineering.

### Software Tools & Technologies Covered
- Autodesk Revit 2024 (Structure)
...
### Industrial Hands-on Capstone Projects
1. **G+5 RCC Commercial Building Complete Structural BIM Model with Full 3D Rebar Detailing**
1. **Industrial Steel Warehouse with Truss Framing, Purlins, Bracing, and Parametric Steel Connections**
1. **Bar Bending Schedule (BBS) and Structural Construction Sheet Package for Multi-Bay Foundation**

---

<a id='civil-3dsmax'></a>
# Autodesk 3ds Max Studio for Architectural Visualization
- **Course Code:** `CIVIL-3DSMAX`
- **Engineering Discipline:** Civil CAD
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 18,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/civil-cad-courses/3ds-max-studio/](https://graphixtechnoservices.com/courses/civil-cad-courses/3ds-max-studio/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Architectural Visualization Certificate.

### Course Overview
Professional 3D modeling, texturing, lighting, and photorealistic rendering curriculum using Autodesk 3ds Max with V-Ray / Arnold. Learn to transform 2D CAD plans into cinematic interior renders and exterior architectural walkthroughs.

### Target Audience & Prerequisites
Basic understanding of architectural plans or AutoCAD/Revit.
...
### Industrial Hands-on Capstone Projects
1. **Modern Residential Living Room Photorealistic Interior Render with Daytime & Night IES Lighting**
1. **Luxury Contemporary Bungalow Exterior Architecture Visualization with Landscaping and HDRI Sky**
1. **Cinematic Architectural Camera Walkthrough Animation Video of a Commercial Building**

---

<a id='civil-adv-steel'></a>
# AutoCAD Advance Steel (Structural Steel Detailing & Fabrication)
- **Course Code:** `CIVIL-ADV-STEEL`
- **Engineering Discipline:** Civil CAD
- **Duration:** 1.5 Months (Approx. 60.0 Hours)
- **Estimated Course Fee:** INR 16,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/civil-cad-courses/autocad-advance-steel-training-course-classes-institute-in-pune/](https://graphixtechnoservices.com/courses/civil-cad-courses/autocad-advance-steel-training-course-classes-institute-in-pune/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Steel Detailing Certificate.

### Course Overview
Specialized course for steel detailers and structural engineers. Learn 3D structural steel modeling, automated parametric joint connections, industrial stairs and railings, fabrication shop drawings, and CNC data export.

### Target Audience & Prerequisites
Degree / Diploma in Civil or Mechanical Engineering with structural drafting knowledge.

### Software Tools & Technologies Covered
- Autodesk Advance Steel 2023 / 2024
...
### Industrial Hands-on Capstone Projects
1. **Industrial Steel Warehouse Portal Frame with Full Parametric Connection Detailing**
1. **Multi-Level Heavy Industrial Pipe Rack Steel Structure with Bracing and Base Plates**
1. **Complete Fabrication Drawing Package (Single Part, Assembly, Erection Drawings, BOM & NC Files)**

---

<a id='civil-plant-3d'></a>
# AutoCAD Plant 3D (Process Piping & Plant Layout)
- **Course Code:** `CIVIL-PLANT-3D`
- **Engineering Discipline:** Civil CAD
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 18,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/civil-cad-courses/autocad-plant-3d-classes-training-institute-course-in-pune/](https://graphixtechnoservices.com/courses/civil-cad-courses/autocad-plant-3d-classes-training-institute-course-in-pune/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Plant Design Certificate.

### Course Overview
Dedicated curriculum for process plant design, piping layouts, equipment modeling, and automated isometric drawings using Autodesk AutoCAD Plant 3D.

### Target Audience & Prerequisites
Diploma / Degree in Mechanical, Chemical, Petroleum, or Civil Engineering.
...
### Industrial Hands-on Capstone Projects
1. **Industrial Boiler Room 3D Plant Layout with Steam & Condensate Piping**
1. **Chemical Dosing Skid with Pump Equipment, Valve Manifolds, and Isometric Generation**
1. **Plant MTO and Orthographic Drawing Package for Client Submittal**

---

<a id='civil-navisworks'></a>
# Autodesk Navisworks Manage (BIM Coordination, Clash Detection & 4D/5D Simulation)
- **Course Code:** `CIVIL-NAVISWORKS`
- **Engineering Discipline:** Civil CAD
- **Duration:** 1.5 Months (Approx. 60.0 Hours)
- **Estimated Course Fee:** INR 16,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/civil-cad-courses/navis-work-course-classes-training-institute-in-pune/](https://graphixtechnoservices.com/courses/civil-cad-courses/navis-work-course-classes-training-institute-in-pune/)
- **Certification:** Central Government ISO Certification & BECIL Authorized BIM Coordination Certificate.

### Course Overview
Master multidisciplinary project coordination, 3D model aggregation, clash detection, 4D construction scheduling simulation, and 5D quantification using Autodesk Navisworks Manage.

### Target Audience & Prerequisites
Familiarity with AutoCAD, Revit, or 3D CAD/BIM models.
...
### Industrial Hands-on Capstone Projects
1. **Commercial High-Rise Multi-Disciplinary (Arch + Struct + MEP) Clash Detection & Resolution Report**
1. **4D Construction Sequence Timeline Simulation for a Stadium Project linked with Primavera P6**
1. **5D Quantification Takeoff and Material Summary for Concrete and Steel Structure**

---

<a id='bim-arch-design'></a>
# Architectural Design & Visualization Master Track
- **Course Code:** `BIM-ARCH-DESIGN`
- **Engineering Discipline:** Design & BIM
- **Duration:** 6 Months (Approx. 240 Hours)
- **Estimated Course Fee:** INR 35,000.00
- **Source Reference:** [https://graphixtechnoservices.com/architectural-design-course/](https://graphixtechnoservices.com/architectural-design-course/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Architectural Design Professional Certificate.

### Course Overview
Full-stack architectural design program spanning 2D drafting, 3D BIM parametric architecture, photorealistic CGI rendering, space planning, and municipal bye-laws. Covers AutoCAD, Revit Architecture, 3ds Max with V-Ray, and Photoshop.

### Target Audience & Prerequisites
B.Arch, Diploma / Degree in Civil / Interior Design, or creative professionals.
...
### Industrial Hands-on Capstone Projects
1. **Comprehensive Design & Working Drawings for a 10-Acre Mixed-Use Residential & Commercial Township**
1. **Photorealistic Exterior and Interior CGI Visualization Portfolio for Luxury High-End Penthouse**
1. **BIM Coordinated Architectural Execution Set with Full Door/Window/Finishes Schedules**

---

<a id='bim-professional'></a>
# BIM (Building Information Modeling) Professional Track
- **Course Code:** `BIM-PROFESSIONAL`
- **Engineering Discipline:** Design & BIM
- **Duration:** 6 Months (Approx. 240 Hours)
- **Estimated Course Fee:** INR 38,000.00
- **Source Reference:** [https://graphixtechnoservices.com/bim-design-course/](https://graphixtechnoservices.com/bim-design-course/)
- **Certification:** Central Government ISO Certification & BECIL Authorized BIM Professional Certificate.

### Course Overview
Master Building Information Modeling across Architecture, Structure, MEP, and Construction Management. Fully aligned with ISO 19650 standards. Covers Revit Architecture, Revit Structure, Revit MEP, Navisworks Manage, and Autodesk Construction Cloud / BIM 360.

### Target Audience & Prerequisites
BE/B.Tech/Diploma in Civil, Mechanical, Electrical Engineering, or Architecture.
...
### Industrial Hands-on Capstone Projects
1. **Smart Metro Station Multi-Discipline BIM Project (Arch + Struct + MEP) with Clash-Free Sign-Off**
1. **Hospital Building 4D Construction Sequence & 5D Cost Estimation Simulation**
1. **BIM Execution Plan (BEP) and CDE Cloud Setup for International Infrastructure Project**

---

<a id='bim-interior-design'></a>
# Interior Design & Space Planning Masterclass
- **Course Code:** `BIM-INTERIOR-DESIGN`
- **Engineering Discipline:** Design & BIM
- **Duration:** 4 Months (Approx. 160 Hours)
- **Estimated Course Fee:** INR 25,000.00
- **Source Reference:** [https://graphixtechnoservices.com/interior-design-course/](https://graphixtechnoservices.com/interior-design-course/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Interior Design Certificate.

### Course Overview
Complete professional interior design program covering residential, commercial, and retail spaces. Learn design theory, space planning, AutoCAD working drawings, 3ds Max / V-Ray 3D visualization, materials, and modular joinery detailing.

### Target Audience & Prerequisites
Any graduate, diploma holder, or creative professional with an interest in interior styling.
...
### Industrial Hands-on Capstone Projects
1. **Luxury 3-BHK Residential Apartment Complete Interior Design & Working Drawing Package**
1. **Modern Corporate Co-Working Space Planning with Ergonomic Workstations and Lounge Areas**
1. **Photorealistic 3D Rendering Portfolio with Mood Boards and Material BOQ**

---

<a id='civil-struct-design'></a>
# Structural Design & Analysis Engineering Masterclass
- **Course Code:** `CIVIL-STRUCT-DESIGN`
- **Engineering Discipline:** Civil CAD
- **Duration:** 5 Months (Approx. 200 Hours)
- **Estimated Course Fee:** INR 30,000.00
- **Source Reference:** [https://graphixtechnoservices.com/structural-design-course/](https://graphixtechnoservices.com/structural-design-course/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Structural Design Engineer Certificate.

### Course Overview
Rigorous structural engineering program covering RCC and structural steel design as per Indian (IS) and International (ACI/AISC) codes. Covers structural mechanics, load calculation, ETABS / STAAD.Pro analysis, Revit Structure BIM, and Advance Steel.

### Target Audience & Prerequisites
BE/B.Tech in Civil or Structural Engineering.

### Software Tools & Technologies Covered
- AutoCAD
- Revit Structure
- Advance Steel
- ETABS / STAAD.Pro / Robot Structural Analysis
...
### Industrial Hands-on Capstone Projects
1. **Earthquake-Resistant G+12 Story RCC Commercial Tower Analysis, Design & Rebar Detailing**
1. **45-Meter Clear Span Industrial PEB Warehouse Design with Advance Steel Fabrication Drawings**
1. **Structural Analysis & Foundation Design for Deep Basement Excavation with Retaining Walls**

---

<a id='elec-autocad'></a>
# Electrical AutoCAD (Schematics, Wiring & Control Panel Layouts)
- **Course Code:** `ELEC-AUTOCAD`
- **Engineering Discipline:** Electrical CAD
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 15,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/electrical-courses/electrical-autocad/](https://graphixtechnoservices.com/courses/electrical-courses/electrical-autocad/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Electrical CAD Certificate.

### Course Overview
Professional electrical computer-aided design training using AutoCAD Electrical toolset. Learn control schematics, ladder diagrams, PLC I/O wiring, terminal block design, panel layout fabrication drawings, and automated bill of materials.

### Target Audience & Prerequisites
Diploma / Degree in Electrical, Electronics, Instrumentation, or Mechatronics Engineering.

### Software Tools & Technologies Covered
- AutoCAD Electrical 2023 / 2024
...
### Industrial Hands-on Capstone Projects
1. **Industrial Motor Control Center (MCC) Panel Schematic & 2D Panel Layout Drawing**
1. **Automated Packaging Machine PLC Control Wiring Diagram with Terminal Strip Details**
1. **Complete Electrical Schematics & BOM Generation for Solar Inverter Control Panel**

---

<a id='mep-revit-mep'></a>
# Autodesk Revit MEP (Mechanical, Electrical, Plumbing BIM Modeling)
- **Course Code:** `MEP-REVIT-MEP`
- **Engineering Discipline:** Electrical CAD
- **Duration:** 3 Months (Approx. 120 Hours)
- **Estimated Course Fee:** INR 22,000.00
- **Source Reference:** [https://graphixtechnoservices.com/courses/electrical-courses/revit-mep-training-in-pune/](https://graphixtechnoservices.com/courses/electrical-courses/revit-mep-training-in-pune/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Revit MEP Professional Certificate.

### Course Overview
Comprehensive 14-chapter curriculum in Autodesk Revit MEP covering HVAC ductwork, mechanical piping, domestic water and sanitary drainage plumbing, and electrical power, lighting, cable tray, and conduit modeling with inter-disciplinary coordination.

### Target Audience & Prerequisites
BE/B.Tech/Diploma in Electrical, Mechanical, Civil Engineering or MEP Draftsmen.

### Software Tools & Technologies Covered
- Autodesk Revit 2024 (MEP)
...
### Industrial Hands-on Capstone Projects
1. **Commercial Office Building Complete MEP BIM Coordinated Model (HVAC + Plumbing + Electrical)**
1. **Hospital Ward Building Medical Gas, Plumbing Drainage, and Cable Tray Distribution Layout**
1. **Multi-Disciplinary Clash Detection and Automated MEP Quantity Schedule Extraction**

---

<a id='elec-design'></a>
# Electrical Design Engineering (Substations, Power Distribution & Lighting)
- **Course Code:** `ELEC-DESIGN`
- **Engineering Discipline:** Electrical CAD
- **Duration:** 3 Months (Approx. 120 Hours)
- **Estimated Course Fee:** INR 22,000.00
- **Source Reference:** [https://graphixtechnoservices.com/electrical-design-course/](https://graphixtechnoservices.com/electrical-design-course/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Electrical Design Engineer Certificate.

### Course Overview
Professional electrical design engineering program for commercial complexes, industrial plants, and substations. Covers load estimation, single-line diagrams (SLD), transformer and DG sizing, short-circuit calculations, cable sizing, earthing design, and Dialux lighting.

### Target Audience & Prerequisites
Degree / Diploma in Electrical or Electrical & Electronics Engineering.
...
### Industrial Hands-on Capstone Projects
1. **Complete Electrical Power Distribution & SLD for a 100,000 sq.ft Corporate IT Park**
1. **Indoor 11kV/415V Substation Equipment Layout with Transformer, DG, and Earthing Grid Design**
1. **DIALux evo Photometric Lighting Simulation and Emergency Lighting Layout for Commercial Showroom**

---

<a id='it-core-java'></a>
# Core Java Programming (Java SE 17 / 21 LTS Masterclass)
- **Course Code:** `IT-CORE-JAVA`
- **Engineering Discipline:** IT & Software Development
- **Duration:** 2 Months (Approx. 80 Hours)
- **Estimated Course Fee:** INR 12,000.00
- **Source Reference:** [https://graphixtechnoservices.com/core-java-course/](https://graphixtechnoservices.com/core-java-course/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Core Java Certificate.

### Course Overview
Industry-aligned Core Java programming course covering fundamental syntax, object-oriented programming (OOP), collections framework, multithreading, exception handling, file I/O, and modern Java 8+ features (Streams, Lambdas).

### Target Audience & Prerequisites
Basic understanding of programming logic or computer science fundamentals.
...
### Industrial Hands-on Capstone Projects
1. **Bank Account Management Console Application with Transaction History & Serialization**
1. **Student Examination Grading & Record System using Java Collections & Custom Sorting**
1. **Multi-Threaded Producer-Consumer Inventory Simulation System**

---

<a id='it-adv-java'></a>
# J2EE & Advanced Java Frameworks (Spring Boot, Hibernate & REST)
- **Course Code:** `IT-ADV-JAVA`
- **Engineering Discipline:** IT & Software Development
- **Duration:** 2.5 Months (Approx. 100.0 Hours)
- **Estimated Course Fee:** INR 18,000.00
- **Source Reference:** [https://graphixtechnoservices.com/j2ee-advance-java/](https://graphixtechnoservices.com/j2ee-advance-java/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Enterprise Java Certificate.

### Course Overview
Master enterprise Java development covering JDBC, Servlets, JSP, Hibernate ORM, Spring Framework, Spring Boot, Spring Data JPA, and secure RESTful web service development.

### Target Audience & Prerequisites
Proficiency in Core Java programming and SQL database basics.
...
### Industrial Hands-on Capstone Projects
1. **Enterprise Employee Leave Management System using Servlets, JSP, and MySQL**
1. **Hospital Patient Appointment Booking RESTful API with Spring Boot & Spring Data JPA**
1. **Secure E-Commerce Backend Service with JWT Authentication, Shopping Cart, and Database Transactions**

---

<a id='it-java-fullstack'></a>
# Java Full Stack Developer (React.js, Spring Boot, Microservices & Cloud)
- **Course Code:** `IT-JAVA-FULLSTACK`
- **Engineering Discipline:** IT & Software Development
- **Duration:** 6 Months (Approx. 240 Hours)
- **Estimated Course Fee:** INR 35,000.00
- **Source Reference:** [https://graphixtechnoservices.com/java-full-stack-developer-course/](https://graphixtechnoservices.com/java-full-stack-developer-course/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Full Stack Developer Certificate.

### Course Overview
End-to-end full stack web development program. Master modern frontend development with HTML5, CSS3, JavaScript ES6+, Bootstrap, and React.js paired with enterprise backend engineering using Core Java, Spring Boot, Hibernate, MySQL, Docker, and Git.

### Target Audience & Prerequisites
Any graduate / engineering student with basic logical aptitude and passion for software development.
...
### Industrial Hands-on Capstone Projects
1. **Coaching Institute Management System (React.js Frontend + Spring Boot Backend + MySQL Database + JWT Auth)**
1. **Real-Time E-Commerce Web Application with Product Catalog, Shopping Cart, and Stripe Payment Gateway**
1. **Social Media / Discussion Forum Platform with User Profiles, Comments, Likes, and File Uploads**

---

<a id='cloud-aws-arch'></a>
# AWS Cloud Solutions Architect (Associate SAA-C03 Certified Track)
- **Course Code:** `CLOUD-AWS-ARCH`
- **Engineering Discipline:** Cloud Computing
- **Duration:** 2.5 Months (Approx. 100.0 Hours)
- **Estimated Course Fee:** INR 20,000.00
- **Source Reference:** [https://graphixtechnoservices.com/aws-certification-course/](https://graphixtechnoservices.com/aws-certification-course/)
- **Certification:** Central Government ISO Certified & BECIL Authorized AWS Cloud Architect Certificate.

### Course Overview
Comprehensive cloud computing and DevOps architecture program aligned with the AWS Certified Solutions Architect Associate (SAA-C03) curriculum. Master IAM, EC2, VPC networking, S3, RDS, Auto Scaling, Route 53, Serverless Lambda, and Cloud Security.

### Target Audience & Prerequisites
Basic understanding of networking concepts, operating systems, or programming.
...
### Industrial Hands-on Capstone Projects
1. **Highly Available, Multi-AZ Fault-Tolerant Web Application Architecture with ALB, Auto Scaling & RDS Multi-AZ**
1. **Serverless Event-Driven Image Thumbnail Processing Pipeline using S3, Lambda, SNS, and DynamoDB**
1. **Secure Corporate Hybrid Cloud VPC Architecture with Public/Private Subnets, NAT Gateways & Bastion Host**

---

<a id='cloud-salesforce'></a>
# Salesforce CRM Cloud (Administrator & Platform Developer Masterclass)
- **Course Code:** `CLOUD-SALESFORCE`
- **Engineering Discipline:** Cloud Computing
- **Duration:** 3 Months (Approx. 120 Hours)
- **Estimated Course Fee:** INR 22,000.00
- **Source Reference:** [https://graphixtechnoservices.com/salesforce-course/](https://graphixtechnoservices.com/salesforce-course/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Salesforce Specialist Certificate.

### Course Overview
Comprehensive Salesforce CRM training covering Salesforce Administrator and Platform Developer I curriculum. Master data modeling, security, flow automations, reports, Apex programming, SOQL, triggers, and Lightning Web Components (LWC).

### Target Audience & Prerequisites
Any graduate or software professional with basic programming or business logic concepts.
...
### Industrial Hands-on Capstone Projects
1. **Coaching Institute Student Admission & Fee Installment Automation in Salesforce**
1. **Customer Support Ticketing & Service Cloud Portal with SLA Milestone Automation**
1. **Custom Course Enrollment Portal built with Lightning Web Components (LWC) and Apex Backend**

---

<a id='it-data-science-ai'></a>
# Data Science, Machine Learning & Artificial Intelligence Masterclass
- **Course Code:** `IT-DATA-SCIENCE-AI`
- **Engineering Discipline:** Data Science & AI/ML
- **Duration:** 5 Months (Approx. 200 Hours)
- **Estimated Course Fee:** INR 32,000.00
- **Source Reference:** [https://graphixtechnoservices.com/data-science-machine-learning-ai/](https://graphixtechnoservices.com/data-science-machine-learning-ai/)
- **Certification:** Central Government ISO Certified & BECIL Authorized Data Science & AI Certificate.

### Course Overview
Comprehensive program in Data Science, Machine Learning, Deep Learning, and Artificial Intelligence. Covers mathematics, Python programming, Exploratory Data Analysis, predictive modeling with Scikit-learn, Neural Networks with TensorFlow/Keras, NLP, and model deployment.

### Target Audience & Prerequisites
Degree in Engineering, Computer Science, Statistics, Mathematics, or any quantitative discipline.
...
### Industrial Hands-on Capstone Projects
1. **Customer Churn Prediction and Risk Classification System using Random Forest and XGBoost**
1. **Medical Disease Diagnosis Prediction Web Application using Machine Learning & Streamlit**
1. **Real-Time Sentiment Analysis Tool for Social Media Product Reviews using Natural Language Processing**

---

<a id='pro-comm-training'></a>
# Corporate Communication & Personality Development Programme
- **Course Code:** `PRO-COMM-TRAINING`
- **Engineering Discipline:** Professional Development
- **Duration:** 1.5 Months (Approx. 60.0 Hours)
- **Estimated Course Fee:** INR 8,000.00
- **Source Reference:** [https://graphixtechnoservices.com/communication-training/](https://graphixtechnoservices.com/communication-training/)
- **Certification:** Central Government ISO Certification & BECIL Authorized Communication Training Certificate.

### Course Overview
Placement-focused communication and professional personality development training designed for engineering freshers, job seekers, and working professionals. Covers spoken English fluency, business correspondence, group discussions, public presentations, and technical/HR interview mastery.

### Target Audience & Prerequisites
Open to all students, job aspirants, and professionals looking to enhance their corporate communication skills.

### Software Tools & Technologies Covered
- MS PowerPoint
- Zoom / Google Meet Professional Etiquette
- LinkedIn
...
### Industrial Hands-on Capstone Projects
1. **Video-Recorded Mock Technical & HR Interview Session with Detailed Performance Scorecard**
1. **Live Group Discussion Simulation Round on Contemporary Technology & Engineering Trends**
1. **Individual 10-Minute Corporate Technical Presentation with Slide Deck & Peer Evaluation**
